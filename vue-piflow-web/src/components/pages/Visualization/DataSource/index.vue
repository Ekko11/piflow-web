<template>
  <section>
    ...
    <Modal
        v-model="isOpen"
        :title="formData.id?$t('datasource.update_title'):$t('datasource.create_title')"
...
export default {
  ...
  methods: {
    handleDatabaseChange(val){
      ...
      const database = this.dataBaseList.find(v=>v.id === val)
