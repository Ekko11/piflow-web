      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              name: "preference",
              component: () =>
                import("../components/pages/CategoryManagement/Preference"),
            },
            {
              path: "/flowHistory",
              name: "flowHistory",
              component: () =>
                import("../components/pages/CategoryManagement/FlowHistory"),
            },
            {
              path: "/producePublishManagement",
              name: "producePublishManagement",
              component: () =>
                import("../components/pages/DataProductManagement/Publish"),
            },
            {
              path: "/produceAccreditManagement",
              name: "produceAccreditManagement",
              component: () =>
                import("../components/pages/DataProductManagement/Accredit"),
            },
            {
              path: "/",
              name: "sections",
            ...
            },
            {
              ...
              name: "globalVariable",
              component: () =>
                import("../components/pages/Admin/globalVariable"),
            },
            // {
            //   path: '/user',
            //   name: 'user',
            ...
            },
            {
              ...
              name: "bindingAccount",
              component: () =>
                import("../components/pages/User/bindingAccount"),
            },
            {
              path: "/visualization/database",
              name: "VisualizationDataBase",
              component: () =>
                import("../components/pages/Visualization/DataBase"),
            },
            {
              path: "/visualization/datasource",
              name: "VisualizationDataSource",
              component: () =>
                import("../components/pages/Visualization/DataSource"),
            },
            {
              path: "/visualization/visualconfig",
              name: "VisualizationVisualConfig",
              component: () =>
                import("../components/pages/Visualization/VisualConfig"),
            },
          ],
        },
        {
        ...
        },
        {
          ...
          name: "GraphConfig",
          component: () =>
            import("../components/pages/Visualization/GraphConfig"),
        },
      ],
    },
    // 门户界面
