...
// 可视化服务地址
window.$VISUALIZATION_BASE='http://10.0.82.210:8088/'

// footer信息
window.$FOOTER_ADD = '北京市朝阳区大屯路甲11号'
window.$FOOTER_TEL = '010-64889273'
window.$FOOTER_EMAIL = 'nesdc@igsnrr.ac.c'
window.$FOOTER_COPY = '国家生态科学数据中心'
